...
int main(int argc, char **argv) {
    ...
    pSequenceCommandHandler engHandler = EngineeringHandler::create();
		CommandUtil::subscribeSequenceCommand(ENGINEERING, SET_PRESET_START_CANCEL, engHandler);

		pSequenceCommandHandler handler = GenericHandler::create();
		CommandUtil::subscribeApply("ig2", SET_PRESET_START_CANCEL, handler);
